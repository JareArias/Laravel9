...
class SeasonController extends Controller
{
    ...
    {   
        ...
        $season->update($validated);
         return Redirect::route('admin.seasons.index', $tvShow->id)->with('flash.banner', 'seasons update.');
    }
    ...
    public function destroy(TvShow $tvShow, Season $season)
    {
        $season->delete();
         ...
         return Redirect::route('admin.seasons.index', $tvShow->id)->with('flash.banner', 'seasons Deleted.')->with('flash.bannerStyle', 'danger');
    }
}
