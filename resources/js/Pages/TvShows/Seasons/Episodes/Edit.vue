        ...
        <div class="py-2">
            <div class="max-w-7xl mx-auto">
                <section class="container mx-auto p-6 font-mono">
                    ...
                    <div
                        class="w-full mb-8 p-6 sm:max-w-md overflow-hidden rounded-lg shadow-lg bg-white"
                    >
...
function submitEpisode() {
    form.put(
        `/admin/tv-shows/${+props.tvShow.id}/seasons/${+props.season
            .id}/episodes/${props.episode.id}`
    );
}
</script>
